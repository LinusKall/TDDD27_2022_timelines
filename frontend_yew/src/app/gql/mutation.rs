...
#[cynic(schema_path = "graphql/schema.graphql", graphql_type = "UpdateUserTimelineInput")]
...
#[cynic(schema_path = "graphql/schema.graphql", graphql_type = "Mutation", argument_struct = "UpdateUserTimelineInput")]
